CLASS zcl_22_struct_data_sample DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_22_struct_data_sample IMPLEMENTATION.
...
**********************************************************************
    ...
    SELECT SINGLE
    FROM /DMO/I_Connection
    FIELDS DepartureAirport AS airport_from_id, \_Airline-Name  AS carrier_name
    WHERE AirlineID = 'LH'
    AND ConnectionID = '0400'
    INTO CORRESPONDING FIELDS OF @connection.

    out->write( `---------------------------------------------------` ).
    out->write( `Example 4: Aliases and INTO CORRESPONDING FIELDSOF` ).
    out->write( connection ).
...
**********************************************************************
    ...
    DestinationAirport AS ArrivalAirport, \_Airline-Name AS carrier_name
    WHERE AirlineID = 'LH'
    AND ConnectionID = '0400'
